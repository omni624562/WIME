...
class CheCJTextService(CinBaseTextService):
    IME_DIR_NAME   = "checj"
    MAX_CHAR_LENGTH = 5
    CIN_FILE_LIST  = ["checj.json", "mscj3.json", "mscj3-ext.json", "cj-ext.json",
                      "cnscj.json", "thcj.json", "newcj3.json", "cj5.json",
                      "newcj.json", "scj6.json", "cj-fast.json"]
